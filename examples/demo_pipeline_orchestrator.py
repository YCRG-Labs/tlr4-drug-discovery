#!/usr/bin/env python3
"""
Demo script for Research Pipeline Orchestrator

This script demonstrates the complete research pipeline orchestrator
with MLflow integration, hyperparameter optimization, and automated reporting.
"""
...
from tlr4_binding.data_processing.data_loader import DataLoader
...
def run_basic_pipeline_demo():
    ...
    config = create_experiment_config(
        ...
        models_to_test=['random_forest', 'xgboost', 'neural_network']
    )
