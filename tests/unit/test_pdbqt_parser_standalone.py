"""
Standalone unit tests for PDBQT file parser and validation.

This test file imports only the parser module directly to avoid dependency issues
while testing the core PDBQT parsing functionality.
"""
...
# Import only the parser module directly
import sys
sys.path.insert(0, '/home/brand/ember-pm/src')

from tlr4_binding.molecular_analysis.parser import PDBQTParser, PDBQTParserInterface
