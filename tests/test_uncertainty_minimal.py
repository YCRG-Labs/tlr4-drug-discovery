#!/usr/bin/env python3
"""
Minimal test for uncertainty quantification methods.
This script tests only the core uncertainty quantification classes.
"""
...
def test_bootstrap_uncertainty_direct():
    """Test Bootstrap uncertainty quantification directly."""
    print("Testing Bootstrap Uncertainty Quantification...")
    
    try:
        # Import only the specific class
        ...
        bootstrap = BootstrapUncertainty(
            ...
            n_bootstrap=5,  # Reduced for faster testing
            random_state=42,
            n_estimators=5
        )
...
def test_conformal_prediction_direct():
    """Test Conformal Prediction directly."""
...
def test_ensemble_uncertainty_direct():
    """Test Ensemble uncertainty quantification directly."""
    ...
    try:
        ...
        models = []
        for i in range(3):
            model = RandomForestRegressor(n_estimators=5, random_state=42+i)
...
def test_uncertainty_calibration_direct():
    """Test uncertainty calibration analysis directly."""
...
def main():
    """Run all tests."""
    print("=" * 60)
    print("UNCERTAINTY QUANTIFICATION MINIMAL TESTS")
    print("=" * 60)
    
    tests = [
        test_bootstrap_uncertainty_direct,
        test_conformal_prediction_direct,
        test_ensemble_uncertainty_direct,
        test_uncertainty_calibration_direct
    ]
